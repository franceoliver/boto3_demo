...
def main():
    ...
    print(f"Launching Public EC2 Instance using AMI: {ami_id}")
...
def modify_instance():
    ...
    ec2.modify_ec2_instance('i-0ef56acb13a7eff31')
...
def stop_instance():
    ...
    ec2.stop_instance('i-0ef56acb13a7eff31')
...
def start_instance():
    ...
    ec2.start_instance('i-0ef56acb13a7eff31')
...
def terminate_instance():
    ...
    ec2.terminate_instance('i-0ef56acb13a7eff31')
